            ...
            <ul id="revolutionul">
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="9400"
                    ...
                    <div class="caption lft slide_item_right"
                         ...
                         data-start="5000"
                         data-easing="easeOutBack">
                        <img src="${URL}assets/frontend/pages/img/revolutionslider/hint1-red.png" id="rev-hint1"
                             alt="Image 1">
                    </div>
                    <div class="caption lfb slide_item_right"
                         ...
                         data-start="5500"
                         data-easing="easeOutBack">
                        <img src="${URL}assets/frontend/pages/img/revolutionslider/hint2-red.png" id="rev-hint2"
                             alt="Image 1">
                    </div>
                </li>
