            ...
            <div class="col-md-4 col-sm-6 pre-footer-col">
                ...
                <div class="photo-stream">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#"><img alt="" src="${URL}assets/frontend/pages/img/people/img5-small.jpg"></a>
                        </li>
                        <li><a href="#"><img alt="" src="${URL}assets/frontend/pages/img/works/img1.jpg"></a></li>
                        <li><a href="#"><img alt="" src="${URL}assets/frontend/pages/img/people/img4-large.jpg"></a>
                        </li>
                        ...
                        <li><a href="#"><img alt="" src="${URL}assets/frontend/pages/img/people/img2-large.jpg"></a>
                        </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 padding-top-10">
                2014 © Metronic Shop UI. ALL Rights Reserved. <a href="#">Privacy Policy</a> | <a href="#">Terms of
                Service</a>
            </div>
            <!-- END COPYRIGHT -->
            <!-- BEGIN PAYMENTS -->
