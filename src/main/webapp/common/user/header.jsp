...
<div class="header">
    <div class="container">
        <a class="site-logo" href="index.html"><img src="${URL}assets/frontend/layout/img/logos/logo-corp-red.png"
        ...
        <div class="header-navigation pull-right font-transform-inherit">
            <ul>
                ...
                <li><a href="http://keenthemes.com/preview/metronic/theme/templates/admin" target="_blank">Admin
                    theme</a></li>
